...
class QuestionTree {
  ...
  QuestionTree copyWith({
    ...
    return QuestionTree(
      ...
      question_type: question_type ?? this.question_type,
      node_type: node_type ?? this.node_type,
    );
  }
  ...
  factory QuestionTree.fromMap(Map<String, dynamic> map) {
    print(map["question_type"]);
    return QuestionTree(
      question: map['question'],
      parent: map['parent'],
      when: map['when'],
      options: List<String>.from(map['options']),
      question_type: QuestionType.values.firstWhere((element) => element.toString()=="QuestionType."+map["question_type"]),
      node_type: NodeType.values.firstWhere((element) => element.toString()=="NodeType."+map["node_type"]),
    );
  }

  String toJson() => json.encode(toMap());

  factory QuestionTree.fromJson(String source) => QuestionTree.fromMap(json.decode(source));
